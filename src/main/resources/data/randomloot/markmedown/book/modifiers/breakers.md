...
### Excavator
**id:** `excavator` | **crafting:** `minecraft:piston` ![piston](item:minecraft:piston)

**Description:** Breaking blocks while crouching mines a 3x3 area perpendicular to the surface.
### Explosive
**id:** `explode` | **crafting:** `minecraft:tnt` ![tnt](item:minecraft:tnt)
...
### Learning
**id:** `learning` | **crafting:** `minecraft:book` ![book](item:minecraft:book)

**Description:** After breaking 10 blocks as allowed by this tool, gain 3 experience points.
### Lumbering
**id:** `lumbering` | **crafting:** `minecraft:stripped_oak_log` ![stripped_oak_log](item:minecraft:stripped_oak_log)

**Description:** Breaking a log fells all connected logs
### Magnetic
**id:** `attracting` | **crafting:** `minecraft:iron_block` ![iron_block](item:minecraft:iron_block)

**Description:** Upon breaking a block (allowed by tool type), all items at that block's position will teleport to you.
### Melting
**id:** `melting` | **crafting:** `minecraft:lava_bucket` ![lava_bucket](item:minecraft:lava_bucket)
...
### Prospector
**id:** `prospector` | **crafting:** `minecraft:raw_gold` ![raw_gold](item:minecraft:raw_gold)

**Description:** Mining stone has a 4% chance to discover bonus minerals.
### Veiny
**id:** `veiny` | **crafting:** `minecraft:diamond_pickaxe` ![diamond_pickaxe](item:minecraft:diamond_pickaxe)
