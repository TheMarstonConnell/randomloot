...
### Fire Starter
**id:** `fire_place` | **crafting:** `minecraft:flint_and_steel` ![flint_and_steel](item:minecraft:flint_and_steel)
...
### Flame Thrower
**id:** `flame_thrower` | **crafting:** `minecraft:fire_charge` ![fire_charge](item:minecraft:fire_charge)

**Description:** Right clicking throws a fire ball.
### Forger's Grace
**id:** `dirt_place` | **crafting:** `minecraft:dirt` ![dirt](item:minecraft:dirt)
...
### Spelunking
**id:** `torch_place` | **crafting:** `minecraft:torch` ![torch](item:minecraft:torch)
...
### Void-Touched
**id:** `void_touched` | **crafting:** `minecraft:ender_pearl` ![ender_pearl](item:minecraft:ender_pearl)
