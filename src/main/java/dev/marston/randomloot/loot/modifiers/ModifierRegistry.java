...
public class ModifierRegistry {
	...
	public static Modifier MOMENTUM_STRIKE = register(new MomentumStrike());
	...
	public static final Set<Modifier> HURTERS = Set.of(CRITICAL, CHARGING, FLAMING, COMBO, DRAINING, POISONOUS,
			WITHERING, BLINDING, BEZERK, NEMESIS, SOULBOUND, SCORCHED, FROZEN, OVERGROWN, MOMENTUM_STRIKE);
